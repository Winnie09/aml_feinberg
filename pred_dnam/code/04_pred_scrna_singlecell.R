...
meth <- readRDS('/home-4/whou10@jhu.edu/scratch/Wenpin/metpred/data/combine/wgbs/sampleme_match_aml.rds')
...
## ---------------------------
seur <- readRDS(paste0('/home-4/whou10@jhu.edu/data2/whou10/aml_feinberg/scrna/', 'AML_integrated_scRNA_seurat.rds'))  
...
saveRDS(m, '/home-4/whou10@jhu.edu/scratch/Wenpin/aml_feinberg/pred_dnam/result/scrna_trainmodel.rds')

## predict
pred <- predict(predexpr, m)
saveRDS(pred, '/home-4/whou10@jhu.edu/scratch/Wenpin/aml_feinberg/pred_dnam/result/scrna_pred.rds')
